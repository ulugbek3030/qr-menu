...
const translations = {
  en: {
    ...
    // Welcome / Auth
    'welcome.subtitle_short': 'Resto-bar',
    'welcome.phone': 'Phone number',
    'welcome.your_name': 'Name',
    'welcome.name_hint': 'How should we address you?',
    'welcome.table': 'Table number (detected)',
    'welcome.enter': 'Enter Menu',
    'welcome.skip': 'Skip',
  ...
  ru: {
    ...
    'welcome.subtitle_short': 'Ресто-бар',
    'welcome.phone': 'Номер телефона',
    'welcome.your_name': 'Имя',
    'welcome.name_hint': 'Как к вам обращаться?',
    'welcome.table': 'Номер стола (определён)',
    'welcome.enter': 'Войти в меню',
  ...
  uz: {
    ...
    'welcome.your_name': 'Ism',
    'welcome.name_hint': 'Sizga qanday murojaat qilish kerak?',
    'welcome.table': 'Stol raqami (aniqlangan)',
    'welcome.enter': 'Menyuga kirish',
  ...
  kk: {
    ...
    'welcome.name_hint': 'Сізге қалай хабарласуға болады?',
    'welcome.table': 'Үстел нөмірі (анықталды)',
    'welcome.enter': 'Мәзірге кіру',
    'welcome.skip': 'Өткізіп жіберу',
